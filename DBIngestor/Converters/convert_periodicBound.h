...
#ifndef DBIngestor_convert_periodicbound_h
#define DBIngestor_convert_periodicbound_h

namespace DBConverter {
    /*! \class convert_periodicbound
     \brief Converter class implementing periodic boundary conditions
     
     Implementation of periodic boundary conditions
     */
	class convert_periodicbound : public Converter {
        
	private:

	public:
        convert_periodicbound();
