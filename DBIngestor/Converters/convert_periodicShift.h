...
#ifndef DBIngestor_convert_periodicshift_h
#define DBIngestor_convert_periodicshift_h

namespace DBConverter {
    /*! \class convert_periodicshift
     \brief Converter class implementing periodic boundary conditions
     
     Implementation of periodic boundary conditions
     */
	class convert_periodicshift : public Converter {
        
	private:

	public:
        convert_periodicshift();
