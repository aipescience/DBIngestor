...
#ifndef DBIngestor_convert_power_h
#define DBIngestor_convert_power_h

namespace DBConverter {
    /*! \class convert_power
     \brief Converter class implementing power-function
     
     Implementation of convert_power-function
     */
	class convert_power : public Converter {
