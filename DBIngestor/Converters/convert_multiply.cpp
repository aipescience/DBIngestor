...
convert_multiply::convert_multiply() {
    string converterName = "CONV_MULTIPLY";
...
Converter * convert_multiply::clone() {
    return new convert_multiply;
}

bool convert_multiply::execute(DBDataSchema::DType thisDType, void* value) {
    assert(value != NULL);
    
	//apply multiply to the value
    switch (thisDType) {
