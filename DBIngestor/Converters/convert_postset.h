...
#ifndef DBIngestor_convert_postset_h
#define DBIngestor_convert_postset_h

namespace DBConverter {
    /*! \class convert_postset
     \brief Converter class implementing set-function
     
     Implementation of convert_postset-function
     */
	class convert_postset : public Converter {
