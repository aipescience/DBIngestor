...
#ifndef DBIngestor_convert_sqrt_h
#define DBIngestor_convert_sqrt_h

namespace DBConverter {
    /*! \class convert_sqrt
     \brief Converter class implementing sqrt-function
     
     Implementation of convert_sqrt-function
     */
	class convert_sqrt : public Converter {
