...
#ifndef DBIngestor_assert_isnegative_h
#define DBIngestor_assert_isnegative_h

namespace DBAsserter {
    /*! \class assert_isnegative
     \brief Asserter class implementing isnegative check
     
     Implementation of isnegative check
     */
	class assert_isnegative : public Asserter {
