...
#ifndef DBIngestor_assert_isnotnan_h
#define DBIngestor_assert_isnotnan_h

namespace DBAsserter {
    /*! \class assert_isnotnan
     \brief Asserter class implementing isnotnan check
     
     Implementation of isnotnan check
     */
	class assert_isnotnan : public Asserter {
