...
#ifndef DBIngestor_assert_ispositive_h
#define DBIngestor_assert_ispositive_h

namespace DBAsserter {
    /*! \class assert_ispositive
     \brief Asserter class implementing ispositive check
     
     Implementation of ispositive check
     */
	class assert_ispositive : public Asserter {
